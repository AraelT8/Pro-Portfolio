...
// component that will be exported to App.js and rendered on the footer of the website
const Footer = () => {
  return (
    <div className='w-full h-[300px] bg-gradient-to-b from-[#D3F9B5] to-[#989FCE] flex flex-col justify-center items-center p-4 text-[#393D3F]'>
      ...
      <div className='flex space-x-4'>
        ...
        <a href='https://twitter.com/digital_Arael' target='_blank' rel='noopener noreferrer'>
